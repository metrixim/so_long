...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/30 22:04:32 by gcarelle          #+#    #+#             */
/*   Updated: 2021/09/30 22:04:37 by gcarelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_player(t_img *img, void *mlx)
{
	...
	img->player.down.pixel = mlx_get_data_addr(img->player.down.img,
			&img->player.down.bpp, &img->player.down.line_size,
			&img->player.down.endian);
	...
	img->player.top.pixel = mlx_get_data_addr(img->player.top.img,
			&img->player.top.bpp, &img->player.top.line_size,
			&img->player.top.endian);
	...
	img->player.left.pixel = mlx_get_data_addr(img->player.left.img,
			&img->player.left.bpp, &img->player.left.line_size,
			&img->player.left.endian);
	...
	img->player.right.pixel = mlx_get_data_addr(img->player.right.img,
			&img->player.right.bpp, &img->player.right.line_size,
			&img->player.right.endian);
}
